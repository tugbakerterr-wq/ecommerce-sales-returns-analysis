/* ==============================================================================
   PROJE: E-Ticaret Satıs ve Iade Performans Analizi(2010-2011)
Veri Kaynagı:Online Retial II Data Set (UCI Machine Learning / Kaggle)
   ============================================================================== */

-- 1. ADIM: Tablolardaki Toplam Satır Sayılarının Kontrol Edilmesi
SELECT 
    'Sales' AS Tablo, 
...
-- 2. ADIM: Genel Finansal Göstergeler (Brüt Satıs, Toplam Iade, Net Ciro ve Iade Oranı)
SELECT 
...
-- 3. ADIM: En Çok Ciro Getiren Ilk 10 Ürün 
SELECT 
    Description,
...
-- 4. ADIM: En Yüksek Iade Tutarına Sahip Ilk 10 Ürün 
SELECT 
    Description,
...
-- 5. ADIM: Ülkelere Göre Siparis Hacmi ve Satıs Cirosu (Top 10 Ülke)
SELECT
    Country, 
...
-- 6. ADIM: En Çok Harcama Yapan Ilk 5 Müsteri (VIP Müsteri Analizi)
SELECT 
    Customer_ID,
...
-- 7. ADIM: Ortalama Sepet Tutarı (Average Order Value - AOV)
SELECT 
    ROUND(SUM(TotalPrice) / COUNT(DISTINCT Invoice), 2) AS OrtalamaSepetTutari
FROM sales;


-- 8. ADIM: Ürün Bazlı Brüt Satıs, Iade Tutarı ve Gerçek Net Ciro Karsılastırması
WITH SatisOzeti AS (
    SELECT 
        StockCode, 
        Description, 
